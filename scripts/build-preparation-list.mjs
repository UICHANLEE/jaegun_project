...
const materials = [
  ["운영", "관리자용 노트북/태블릿", "관리자 페이지", 1, "대여/준비", "http://localhost:8123/jaegunadmin.html 접속. 힌트 오픈 현황과 정답 확인용.", "상", "", "운영자 1명 전담"],
  ["운영", "참가자용 QR 안내지", "참가자 페이지", "팀별 1장", "인쇄", "http://localhost:8123/ 기본 주소를 QR로 제작. 입장 시 팀별 배포.", "상", "", "휴대폰 화면 기준"],
